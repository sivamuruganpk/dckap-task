...
if (basename($_FILES["product_image"]["name"]) == '')
{
    ...
    $product_image_file = $_POST['product_image_clone'];
...
if (in_array($product_image_file_type, $allowes_type))
{
    ...
    if (move_uploaded_file($_FILES["product_image"]["tmp_name"], $product_image_file) || $existing_image)
    {
        ...
        $product_create = $product->productUpdate();
